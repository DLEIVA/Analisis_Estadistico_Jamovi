...
\newenvironment{rmdblock}[1]
  ...
  \renewcommand{\labelitemi}{
    \raisebox{-.7\height}[0pt][0pt]{
      {\setkeys{Gin}{width=3em,keepaspectratio}\includegraphics{imgs/#1}}
    }
  }
  \item
  }
...
\urlstyle{same}
\hypersetup{
  pdftitle={Estadística Aplicada con Jamovi},
  pdfauthor={D. Leiva, S. Marti, R. Manolov, A. Sanchez, A. Solanas},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Estadística Aplicada con Jamovi}
\author{D. Leiva, S. Marti, R. Manolov, A. Sanchez, A. Solanas}
\date{2024-09-06}
...
\chapter{El programa Jamovi}\label{jamovi}
...
\chapter{Estadística descriptiva univariante con Jamovi}\label{estaduxedstica-descriptiva-univariante-con-jamovi}
...
\chapter{Estadística descriptiva bivariante con Jamovi}\label{estaduxedstica-descriptiva-bivariante-con-jamovi}
...
\chapter{Probabilidad con Jamovi}\label{probabilidad-con-jamovi}
...
\chapter{Estimación}\label{estim}
...
\chapter{Contrastes no paramétricos con Jamovi}\label{contrastes-no-paramuxe9tricos-con-jamovi}
...
\chapter{Contrastes no paramétricos con Jamovi}\label{noparam}
...
\chapter{Modelos de regresión con Jamovi}\label{regress}
